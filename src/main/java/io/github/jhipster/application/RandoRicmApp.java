...
public class RandoRicmApp {

    private static final Logger log = LoggerFactory.getLogger(RandoRicmApp.class);

    private final Environment env;

    public RandoRicmApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes RandoRICM.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(RandoRicmApp.class);
