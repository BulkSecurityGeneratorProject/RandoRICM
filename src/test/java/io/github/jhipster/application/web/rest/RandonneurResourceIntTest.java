...
public class RandonneurResourceIntTest {
    ...
    private static final Integer DEFAULT_VMA = 1;
    private static final Integer UPDATED_VMA = 2;
    ...
    public void createRandonneur() throws Exception {
        ...
        assertThat(testRandonneur.getTel()).isEqualTo(DEFAULT_TEL);
        assertThat(testRandonneur.getVma()).isEqualTo(DEFAULT_VMA);
        assertThat(testRandonneur.getPoids()).isEqualTo(DEFAULT_POIDS);
    }
    ...
    public void getAllRandonneurs() throws Exception {
        ...
        restRandonneurMockMvc.perform(get("/api/randonneurs?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].vma").value(hasItem(DEFAULT_VMA)))
    ...
    public void getRandonneur() throws Exception {
        ...
        restRandonneurMockMvc.perform(get("/api/randonneurs/{id}", randonneur.getId()))
            ...
            .andExpect(jsonPath("$.vma").value(DEFAULT_VMA))
    ...
    public void updateRandonneur() throws Exception {
        ...
        assertThat(testRandonneur.getTel()).isEqualTo(UPDATED_TEL);
        assertThat(testRandonneur.getVma()).isEqualTo(UPDATED_VMA);
        assertThat(testRandonneur.getPoids()).isEqualTo(UPDATED_POIDS);
    }
